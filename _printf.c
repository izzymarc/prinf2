...
int _printf(const char *format, ...)
{
    ...
    va_list args;  // To handle the variable number of arguments
    int i = 0;     // Loop index for iterating through the format string
    char ch;       // Temporary character for `%c`
    char *str;     // Temporary string for `%s`
